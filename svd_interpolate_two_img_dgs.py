    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                latents = self.scheduler.step_multi_dgs(noise_pred, t, latents,temp_cond_latents,mask,lambda_ts,step_i=i).prev_sample
...
if __name__ == "__main__":
    ...
    frames = pipe([image_o],temp_cond=cond_image+[image_o2],mask = masks,lambda_ts=lambda_ts,num_frames=25, decode_chunk_size=8,num_inference_steps=100).frames[0]
