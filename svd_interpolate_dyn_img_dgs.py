...
def svd_render(image_o,masks, cond_image,warped_img_path,output_path,lambda_ts,weight_clamp):
    pipe = StableVideoDiffusionPipeline.from_pretrained("stabilityai/stable-video-diffusion-img2vid-xt", torch_dtype=torch.float16, variant="fp16")
    pipe.to("cuda")
...
if __name__ == "__main__":
    ...
    svd_render(image_o,masks, cond_image,save_path,output_path,lambda_ts,args.weight_clamp)
